create procedure "_APM"."MaintenancePartsSearchEquipment"( 
...
2019-02-15 JLD E-04898 D-04245 Added @ModuleRowId
*/
  ...
  if(@PartsSource = 'Logistics Database') or(@PartsSource = '''Logistics Database''') then
    select
      ...
      from "APM"."MaintenancePartsSearchLogisticsEquipment"(@VesselId,@EquipmentId,@MaintenanceProcedureId,@APLSource,@UseVessel,@NavyStockNumber,
