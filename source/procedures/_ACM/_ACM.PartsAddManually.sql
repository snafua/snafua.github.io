...
begin
  /*
2018-08-14 RJM
2018-12-19 JLD E-04166 B-19397
*/
  ...
  call "ACM"."PartsAddManually"(@VesselId,@EquipmentRowIdStr,@NavyStockNumber,@PartNumber,@PartDescription,@SupplierName,@CageCode,@QuantityRequired,@UnitCost,@UnitOfMeasure)
end