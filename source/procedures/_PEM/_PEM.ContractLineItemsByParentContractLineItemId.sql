...
--RJM
"_PEM"."ContractLineItemsByParentContractLineItemId"( 
  in @VesselId integer,
  in @ParentLineItemId integer ) 
result( 
  "VesselId" integer,
  "ContractId" integer,
  "WorkItemId" integer,
...
*/
  call "PEM"."ContractLineItemsByParentContractLineItemId"(@VesselId,@ParentLineItemId)
end