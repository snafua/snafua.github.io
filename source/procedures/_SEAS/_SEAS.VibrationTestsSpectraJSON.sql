create function "_SEAS"."VibrationTestsSpectraJSON"( in @SiteId smallint,in @EquipmentId integer,in @TestResultId integer,
...
begin
  ...
  set @Result = "SEAS"."VibrationTestsSpectraJSON"(@SiteId,@EquipmentId,@TestResultId,@PointId,@DLLUnits,@Averaging,@Reference,@FUnits);
  return(@Result)
end